...
parser.add_argument('--train_list', type=str,   default="../../../datasets/FinvCup2024/finvcup9th_1st_ds5/finvcup9th_1st_ds5_train_data.csv",     help='The path of the training list, eg:"/data08/VoxCeleb2/train_list.txt" in my case')
parser.add_argument('--eval_list',  type=str,   default="../../../datasets/FinvCup2024/finvcup9th_1st_ds5/finvcup9th_1st_ds5_valid_data.csv",     help='The path of the evaluation list, eg:"/data08/VoxCeleb1/veri_test2.txt" in my case')
